...
class Interceptor extends \Magento\Backend\Block\Widget\Grid\ColumnSet implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setSortable($value)
    {
        ...
        if (!$pluginInfo) {
            return parent::setSortable($value);
        } else {
            return $this->___callPlugins('setSortable', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setRendererType($type, $className)
    {
        ...
        if (!$pluginInfo) {
            return parent::setRendererType($type, $className);
        } else {
            return $this->___callPlugins('setRendererType', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setFilterType($type, $className)
    {
        ...
        if (!$pluginInfo) {
            return parent::setFilterType($type, $className);
        } else {
            return $this->___callPlugins('setFilterType', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function hasMultipleRows($item)
    {
        ...
        if (!$pluginInfo) {
            return parent::hasMultipleRows($item);
        } else {
            return $this->___callPlugins('hasMultipleRows', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function shouldRenderTotal()
    {
        ...
        if (!$pluginInfo) {
            return parent::shouldRenderTotal();
        } else {
            return $this->___callPlugins('shouldRenderTotal', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isHeaderVisible()
    {
        ...
        if (!$pluginInfo) {
            return parent::isHeaderVisible();
        } else {
            return $this->___callPlugins('isHeaderVisible', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isFilterVisible()
    {
        ...
        if (!$pluginInfo) {
            return parent::isFilterVisible();
        } else {
            return $this->___callPlugins('isFilterVisible', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getGrid()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getGrid', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setCountTotals($flag = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::setCountTotals($flag);
        } else {
    ...
    public function getSubTotals($item)
    {
        ...
        if (!$pluginInfo) {
            return parent::getSubTotals($item);
        } else {
    ...
    public function updateItemByFirstMultiRow(\Magento\Framework\DataObject $item)
    {
        ...
        if (!$pluginInfo) {
            return parent::updateItemByFirstMultiRow($item);
        } else {
            return $this->___callPlugins('updateItemByFirstMultiRow', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function _prepareSubTotals()
    {
        ...
        if (!$pluginInfo) {
            return parent::_prepareSubTotals();
        } else {
            return $this->___callPlugins('_prepareSubTotals', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function _prepareTotals()
    {
        ...
        if (!$pluginInfo) {
            return parent::_prepareTotals();
        } else {
            return $this->___callPlugins('_prepareTotals', func_get_args(), $pluginInfo);
        }
    }

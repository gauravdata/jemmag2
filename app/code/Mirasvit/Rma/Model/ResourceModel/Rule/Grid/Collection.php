...
namespace Mirasvit\Rma\Model\ResourceModel\Rule\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Api\Search\AggregationInterface;
use Mirasvit\Rma\Api\Data\RuleInterface;
use Mirasvit\Rma\Model\ResourceModel\Rule\Collection as RuleCollection;
...
class Collection extends RuleCollection implements SearchResultInterface
{
    ...
    public function __construct(
        ...
        $eventPrefix = 'rma_rule_grid_collection',
        $eventObject = 'rule_grid_collection',
        $resourceModel = 'Mirasvit\Rma\Model\ResourceModel\Rule',

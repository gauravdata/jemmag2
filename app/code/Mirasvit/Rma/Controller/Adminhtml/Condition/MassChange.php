...
class MassChange extends \Mirasvit\Rma\Controller\Adminhtml\Condition
{
    /**
     * {@inheritdoc}
     */
    public function execute()
    {
        ...
        if (!is_array($ids)) {
            if ($this->getRequest()->getParam('excluded')) {
                ...
                $collection = $objectManager->create('Mirasvit\Rma\Model\ResourceModel\Condition\Collection')->load();

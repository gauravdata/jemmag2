...
class MassDelete extends \Mirasvit\Rma\Controller\Adminhtml\Reason
{
    /**
     * {@inheritdoc}
     */
    public function execute()
    {
        ...
        if (!is_array($ids)) {
            if ($this->getRequest()->getParam('excluded')) {
                ...
                $collection = $objectManager->create('Mirasvit\Rma\Model\ResourceModel\Reason\Collection')->load();

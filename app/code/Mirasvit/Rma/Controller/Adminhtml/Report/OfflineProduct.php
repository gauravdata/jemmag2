...
class OfflineProduct extends Action
{
    ...
    protected function initPage($resultPage)
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Offline Product Reports'));
        return $resultPage;
    }
    /**
     * {@inheritdoc}
    ...
    {
        $this->registry->register('current_report', $this->reportRepository->get('rma_offline_product'));

...
class OfflineProduct extends AbstractReport
{
    ...
    public function init()
    {
        ...
        $this->addColumns([
            'mst_rma_offline_item|created_at__quarter',
        ]);

        $this->setDefaultFilters([
            ['mst_rma_offline_item|qty_requested', 0, 'gt'],
        ]);
        ...
        $this->setDefaultDimension('mst_rma_offline_item|name');

        $this->addDimensions([
            'mst_rma_offline_item|created_at__day',
            'mst_rma_offline_item|created_at__week',
            'mst_rma_offline_item|created_at__month',
            'mst_rma_offline_item|created_at__year',
        ]);

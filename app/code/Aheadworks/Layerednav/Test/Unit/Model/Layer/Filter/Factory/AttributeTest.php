...
use Aheadworks\Layerednav\Model\Layer\Filter\Factory\Attribute;
...
/**
 * Test for \Aheadworks\Layerednav\Model\Layer\Filter\Factory\Attribute
 */
class AttributeTest extends TestCase
{
    ...
    public function testGetData()
    {
        ...
        $expectedResult = [
            ...
            LayerFilter::ATTRIBUTE => $attributeMock,
        ...
        $this->assertEquals($expectedResult, $this->model->getData($filterMock, $attributeMock));
    }
    ...
    public function testGetDataImageError()
    {
        ...
        $this->model->getData($filterMock, $attributeMock);
    }

    /**
     * Test getData method if no attribute specified
     *
     * @expectedException \Exception
     * @expectedExceptionMessage No attribute specified!
     */
    public function testGetDataNoAttribute()
    {
        $code = 'code';
        $title = 'title';
        $type = 'title';
        ...
        $this->model->getData($filterMock, null);
    }

 ...
 */
class ValueInsteadOfIdTest extends TestCase
{
    /**
    ...
    {
        return [
            ['isPatchMatched' => true, 'params' => ['attr1' => 'value'], 'result' => true],
            ['isPatchMatched' => true, 'params' => ['attr1' => 'value1-value2'], 'result' => true],
            ['isPatchMatched' => true, 'params' => ['attr1' => '1kg'], 'result' => true],
            ['isPatchMatched' => true, 'params' => ['attr1' => '1,2'], 'result' => false],
            ['isPatchMatched' => true, 'params' => ['price' => '10.00'], 'result' => true],
            ['isPatchMatched' => true, 'params' => ['price' => '10.00-20.00'], 'result' => true],
            ['isPatchMatched' => true, 'params' => ['price' => '10.00,20.00'], 'result' => false],
            ['isPatchMatched' => true, 'params' => ['cat' => 'category'], 'result' => true],
            ['isPatchMatched' => true, 'params' => ['cat' => 'category1-category2'], 'result' => true],
            ['isPatchMatched' => true, 'params' => ['cat' => '1,2'], 'result' => false],
            ['isPatchMatched' => true, 'params' => ['aw_new' => 'new'], 'result' => true],
            ['isPatchMatched' => true, 'params' => ['aw_new' => 1], 'result' => false],
            ['isPatchMatched' => true, 'params' => [], 'result' => false],
            ['isPatchMatched' => true, 'params' => ['attr1' => ['value']], 'result' => false],
            ['isPatchMatched' => true, 'params' => ['attr1' => 'value1', 'attr2' => ['value1']], 'result' => false],
            ['isPatchMatched' => true, 'params' => ['price' => ['10.00']], 'result' => false],
            ['isPatchMatched' => false, 'params' => ['attr1' => 'value'], 'result' => false],
            ['isPatchMatched' => false, 'params' => ['attr1' => '1kg'], 'result' => false],
            ['isPatchMatched' => false, 'params' => ['price' => '10.00'], 'result' => false],
            ['isPatchMatched' => false, 'params' => ['cat' => 'category'], 'result' => false],
            ['isPatchMatched' => false, 'params' => ['aw_new' => 'new'], 'result' => false],
        ];
    }
}

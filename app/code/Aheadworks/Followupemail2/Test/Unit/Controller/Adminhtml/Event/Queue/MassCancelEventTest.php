...
use Aheadworks\Followupemail2\Controller\Adminhtml\Event\Queue\MassCancelEvent;
...
/**
 * Test for \Aheadworks\Followupemail2\Controller\Adminhtml\Event\Queue\MassCancelEvent
 */
class MassCancelEventTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var MassCancelEvent
     */
    ...
    public function testExecute()
    {
        ...
        $this->messageManagerMock->expects($this->once())
            ...
            ->with(__('A total of %1 email chain(s) have been cancelled.', $eventQueueCount))
            ->willReturnSelf();
    ...
    /**
     * Test execute method if not all event chains are cancelled
     */
    public function testExecuteNotAllCancelled()
    {
        $eventQueueIds = [1, 2];
        $eventQueueCount = 1;
    ...
    public function testExecuteWithException()
    {
        ...
        $this->messageManagerMock->expects($this->exactly(2))
            ...
            ->withConsecutive([$errorMessage], [__('None of selected email chains can be cancelled.')])
            ->willReturnSelf();

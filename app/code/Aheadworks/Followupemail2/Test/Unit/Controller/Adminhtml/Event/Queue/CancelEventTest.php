...
use Aheadworks\Followupemail2\Controller\Adminhtml\Event\Queue\CancelEvent;
 ...
 */
class CancelEventTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var CancelEvent
     */
    ...
    public function testExecute()
    {
        ...
        $this->messageManagerMock->expects($this->once())
            ...
            ->with(__('The email chain was successfully cancelled.'))
            ->willReturnSelf();

...
use Aheadworks\Followupemail2\Controller\Adminhtml\Event\Queue\MassCancel;
...
/**
 * Test for \Aheadworks\Followupemail2\Controller\Adminhtml\Event\Queue\MassCancel
 */
class MassCancelTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExecute()
    {
        ...
        $this->messageManagerMock->expects($this->once())
            ...
            ->with(__('A total of %1 email(s) have been cancelled.', $eventQueueCount))
            ->willReturnSelf();
    ...
    /**
     * Test execute method if not all emails are cancelled
     */
    ...
    public function testExecuteWithException()
    {
        ...
        $this->messageManagerMock->expects($this->exactly(2))
            ...
            ->withConsecutive([$errorMessage], [__('None of selected emails can be cancelled.')])
            ->willReturnSelf();
